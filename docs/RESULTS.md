...
- [2026-08-28 — TerraConstructs port (Option C) live run](results/2026-08-28-tcons.md) — `TestTcons` PASS — the port built into TerraConstructs itself, plus the OpenTofu-registry blocker on its own integ target.
