...
Companion to [awscc-gaps.md](awscc-gaps.md), which covers the resource-level gaps: this file
covers the *template-language* ones — what a CDK-shaped construct library needs from
CloudFormation that neither awscc nor hashicorp/aws expresses at all.
